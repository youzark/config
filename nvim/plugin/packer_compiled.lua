...
_G.packer_plugins = {
  ...
  taskwiki = {
    loaded = true,
    path = "/home/hyx/.local/share/nvim/site/pack/packer/start/taskwiki",
  ...
  ultisnips = {
    loaded = true,
    path = "/home/hyx/.local/share/nvim/site/pack/packer/start/ultisnips",
  ...
  ["vim-ipython-cell"] = {
    loaded = true,
    path = "/home/hyx/.local/share/nvim/site/pack/packer/start/vim-ipython-cell",
  ...
  ["vim-livedown"] = {
    loaded = true,
    path = "/home/hyx/.local/share/nvim/site/pack/packer/start/vim-livedown",
    url = "https://github.com/shime/vim-livedown"
  },
  ["vim-markdown"] = {
    loaded = true,
    path = "/home/hyx/.local/share/nvim/site/pack/packer/start/vim-markdown",
  ...
  ["vim-plugin-AnsiEsc"] = {
    loaded = true,
    path = "/home/hyx/.local/share/nvim/site/pack/packer/start/vim-plugin-AnsiEsc",
    url = "https://github.com/powerman/vim-plugin-AnsiEsc"
  },
  ["vim-slime"] = {
    loaded = true,
    path = "/home/hyx/.local/share/nvim/site/pack/packer/start/vim-slime",
  ...
  ["vim-startuptime"] = {
    loaded = true,
    path = "/home/hyx/.local/share/nvim/site/pack/packer/start/vim-startuptime",
    url = "https://github.com/dstein64/vim-startuptime"
  },
  ["vim-test"] = {
    loaded = true,
    path = "/home/hyx/.local/share/nvim/site/pack/packer/start/vim-test",
  ...
  vimwiki = {
    loaded = true,
    path = "/home/hyx/.local/share/nvim/site/pack/packer/start/vimwiki",
